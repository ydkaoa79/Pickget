                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ListView(
                                          padding: const EdgeInsets.symmetric(horizontal: 16),
                                          children: [
                                            _commentItem('멋진 여행자', '와! 저는 A가 훨씬 세련되어 보여요. 스타일이 딱 제 취향!', 1, 'https://i.pravatar.cc/150?u=a1'),
                                            _commentItem('패션매니아', '에이, 그래도 겨울엔 레드 포인트가 있는 B가 진리죠!', 2, 'https://i.pravatar.cc/150?u=b1'),
                                            _commentItem('깔끔쟁이', 'A의 사이언 컬러가 사진의 전체적인 무드랑 너무 잘 어울리네요.', 1, 'https://i.pravatar.cc/150?u=a2'),
                                            _commentItem('익명러', 'B가 더 고급스러워 보여요. 저만 그런가요?', 2, 'https://i.pravatar.cc/150?u=b2'),
                                          ],
                                        ),
                                      ),
                                      Container(
